...
interface UserClient {
    ...
    @GET("movie/popular")
    suspend fun getPopularMoviesCoroutine(@Query("api_key") apiKey: String = com.example.cinema.api.service.apiKey,
    ...
    @GET("movie/{movie_id}")
    suspend fun getMovieByIdCoroutine(@Path("movie_id") movieId: Int = 1,
                                      @Query("api_key") apiKey: String = com.example.cinema.api.service.apiKey
    ):Response<MoviesData>
